...
MappingActions Random::buildTaskToNodeMapping(const TaskSet &tasks)
{
    ...
    //
    //    std::vector<NodePtrVec::size_type> nodeIndices(nodes.size());
    ...
    //            continue;
    //
    //        // automatically throw out previously assigned task from currently selected node back to the queue UNLESS
    //        it
