#include "OnlineFlowtimeAssessorWithMigrationsAndPreemptions.hpp"
#include <cstdint>
...
OnlineFlowtimeAssessorWithMigrationsAndPreemptions::OnlineFlowtimeAssessorWithMigrationsAndPreemptions(
    const DifferenceCalculatorPtr &differenceCalculator, const TimingServicePtr &timingService)
    : MappingAssessorBase(differenceCalculator), timingService(timingService)
{
}

double OnlineFlowtimeAssessorWithMigrationsAndPreemptions::assess(const policy::NodeToTaskMapping &mapping)
{
...
std::uint32_t OnlineFlowtimeAssessorWithMigrationsAndPreemptions::calculateTaskFlowtime(const TaskPtr &task)
{
