#include "ShortestRemainingTimeFirstWithMigrations.hpp"
...
ShortestRemainingTimeFirstWithMigrations::ShortestRemainingTimeFirstWithMigrations(
    const InfrastructureCPtr &infrastructure, const logger::LoggerPtr &logger)
    : PolicyBase(infrastructure, logger)
{
}

NodeToTaskMapping ShortestRemainingTimeFirstWithMigrations::buildNodeToTaskMapping(const TaskPtrVec &tasks)
{
...
std::string ShortestRemainingTimeFirstWithMigrations::toString() const
{
    return "ShortestRemainingTimeFirstWithMigrations";
}
